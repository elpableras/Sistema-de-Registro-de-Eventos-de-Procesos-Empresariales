...
public class PantallaGerente extends JFrame implements Printable {
	...
	/**
	 * Método para imprimir pantalla Gerente.
	 */
	...
	/**
	 * Método que inicializa el botón de Ver Contratos Pendientes.
	 * 
	...
	/**
	 * Método que inicializa la etiqueta de Opción.
	 * 
	 * @return javax.swing.JLabel.
	 */
	...
	/**
	 * Método que para muestra los contratos por validar.
	 */
	public void mostrarContratos() {
		// PASO r03
		// CODIGO DE CONTRATACIÓN DIFERENCIAREMOS LOS REGISTROS, RECOGERLO DE LA
		// BASE DE DATOS
		String[] contratos;
		try {
	...
	/**
	 * Método para rellenar el registro especifico de Gerente.
	 */
	...
	/**
	 * Método que inicializa el botón de Aceptar Validación.
	 * 
	 * @return javax.swing.JButton.
	 */
