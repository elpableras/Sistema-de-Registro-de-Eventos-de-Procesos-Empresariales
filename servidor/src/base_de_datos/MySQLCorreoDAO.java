...
/**
 * Clase que implementa la interfaz de correo.
 */
	...
	public String getCuenta() throws SQLException {
		...
		try {
			...
			PreparedStatement ps = conn
					.prepareStatement("SELECT AES_DECRYPT(usuario, '@pass') AS usuario, AES_DECRYPT(password, '@pass') AS password FROM correo;");
